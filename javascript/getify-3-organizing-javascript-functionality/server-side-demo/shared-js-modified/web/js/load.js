...
(function (global) {
  ...
  global.$LAB.setGlobalDefaults({ CacheBust: true });

  global.$LAB
    .script("//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js")

    .script("/js/external/asq.js")
    .script("/js/external/asq.contrib.js")
    .script("/js/external/grips.debug.min.js")
    .script("/js/external/history.js")
    .script("/js/external/eventemitter2.js")
    .wait(function () {
      // setup the global event hub
