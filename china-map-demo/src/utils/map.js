  ...
  return {
    ...
    tooltip: {
      ...
      formatter: (params) => {
        if (params.seriesType === "lines") {
          ...
          return `<div class='mapTooltip'><span class='textContentKey'>${params.data.fromName} -> ${params.data.toName}</span></div>`;
          // }: </span><br/><span class='textContentValue'>攻击次数:${countTransform(
          //   details
          // )}</span><br/></div>`;
        } else {
          return;
    ...
    geo: [
      ...
      },
      {
        ...
        itemStyle: {
          areaColor: "#1b254f", // 2d国家区域填充
          borderColor: "#6ba5a4", //    2d国家区域边界线
          emphasis: {
            areaColor: "#2a56d5",
          },
        },
    ...
    series: [
        ...
        effect: {
          ...
          color: {
            ...
            colorStops: [
              {
                offset: 0,
                color: "rgba(0, 255, 228, 1)", // 0% 处的颜色
              },
              {
                offset: 1,
                color: "rgba(0, 255, 228, 0)", // 100% 处的颜色
              },
            ],
          },
          symbolSize: 5,
      ...
      // 2 : 涟漪散点
      {
        ...
        itemStyle: {
          normal: {
            color: "#00FFE4", // 航线的目标
            shadowColor: "rgba(0, 255, 228, 0.3)",
            shadowBlur: 10,
            borderColor: "rgba(0, 255, 228, 0.6)",
            borderWidth: 1,
          },
        },
        data: [],
