  ...
  <div class="container">
    <div class="wrapper">
      <div class="bar">
        ...
        <span class="bar__count count-online">346</span>
        <!-- <span class="bar__count">{{ asset.assetStatus.online }}</span> -->
        <span class="bar__title">离线资产数</span>
        <span class="bar__count count-offline">132</span>
...
#map {
  width: 100%;
  height: 100%;
  /* background-image: url(/src/assets/images/map_background.gif) bottom/contain
...
.bar {
  ...
  align-items: center;
  position: relative;
  background: url("/src/assets/images/env_title.svg") 0 0/100% 100% no-repeat;
  // margin-top: 20px;
